...
<body>
    ...
    <ul id="myDIV">
        ...
        <li><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
            <hr>
        </li>
    ...
    <div class="container">
        ...
        <br>
        <h1 align="center">Donate Blood Nearby..</h1><br>
...
-->
        ...
        <table align="center" width="80%" border="1" class="dataprovided">
            ...
            if (isset($_POST['submit'])) {
                ...
                $bgroup = mysqli_real_escape_string($con, $_GET['bgroup']);
